...
class Metanorma < Formula
  ...
  url "https://github.com/metanorma/metanorma-cli/archive/v1.2.11.tar.gz"
  # curl -sL https://github.com/metanorma/metanorma-cli/archive/v1.2.11.tar.gz | shasum -a 256
